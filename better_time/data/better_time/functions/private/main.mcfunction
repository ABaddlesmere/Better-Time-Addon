...
execute if score _bt-track btSB <= _bt-const2 btSB run bossbar set better_time:main name [{"text":"☀ ","color":"#f2de05"},{"text":"Time: ","color":"#af128"},{"score":{"name":"_bt-reg0","objective":"btSB"},"color":"#96ff1f"},{"text":":00","color":"#96ff1f"},{"text":" | ","color":"#bd0000"},{"text":"Day: ","color":"#f57a07"},{"score":{"name":"_bt-day","objective":"btSB"},"color":"#f2db29"},{"text":" ☀","color":"#f2de05"}]

execute if score _bt-track btSB > _bt-const2 btSB run bossbar set better_time:main name [{"text":"☽ ","color":"#bfbfbf"},{"text":"Time: ","color":"#af128"},{"score":{"name":"_bt-reg0","objective":"btSB"},"color":"#96ff1f"},{"text":":00","color":"#96ff1f"},{"text":" | ","color":"#bd0000"},{"text":"Day: ","color":"#f57a07"},{"score":{"name":"_bt-day","objective":"btSB"},"color":"#f2db29"},{"text":" ☽","color":"#bfbfbf"}]
